...
public class InicioMap {
	WebDriver driver;
	String lista1[] = { "//input[@name='inputName']", "//input[@name='address']", "//input[@name='city']",
			"//input[@name='state']", "//input[@name='zipCode']", "//input[@name='creditCardNumber']",
			"//input[@name='creditCardMonth']", "//input[@name='creditCardYear']", "//input[@name='nameOnCard']" };
	...
	public Element selectCidadeSaida = new Element(driver, ByValue.XPATH,
			"//div[@class='container']//select[@name='fromPort']");

	//// div[@class='container']//select[@name='toPort']
	public Element selectDestino = new Element(driver, ByValue.XPATH,
			"//div[@class='container']//select[@name='toPort']");
	...
	// função que varre um vetor que contém xpath dos campos do formulário, que
	// serão preenchidos com os itens da lista2
	public Element preencheForm(int i) {
